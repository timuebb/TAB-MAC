...
def load_gpt2_model(path: str):
    kwargs = {
        "output_attentions": True,
        "output_hidden_states": True,
    }
    try:
        return GPT2Model.from_pretrained(path, attn_implementation="eager", **kwargs)
    except TypeError:
        return GPT2Model.from_pretrained(path, **kwargs)
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.gpt2 = load_gpt2_model('ts_benchmark/baselines/LLM/checkpoints/gpt2')
        ...
        self.gpt2.to(device=get_device())
