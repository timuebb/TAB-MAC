...
_DEFAULT_TRAIN_SPLIT_RATIO = 0.5
...
def load_series_info(file_path: str) -> dict:
    ...
    try:
        ...
        inferred_freq = pd.infer_freq(time_stamp)
        freq = FREQ_MAP.get(inferred_freq, "other")
    except (ValueError, TypeError):
        pass
    train_lens = int(length * _DEFAULT_TRAIN_SPLIT_RATIO)
